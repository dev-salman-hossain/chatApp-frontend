...
const LiveDemoSection: React.FC = () => {
  ...
  return (
    <section id="demo" className="py-8 lg:py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto bg-[#161B22] border border-gray-800 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="bg-gray-900/90 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white flex items-center gap-2">
                ...
                <span className="text-[10px] bg-green-500/20 text-green-400 px-2 py-0.5 rounded font-semibold">Online</span>
              </h4>
          ...
          <div className="hidden sm:flex gap-2">
            ...
            <button
              ...
              className="text-xs bg-green-500/10 hover:bg-green-500/20 text-green-400 px-3 py-1.5 rounded-lg border border-green-500/30 transition-colors flex items-center gap-1"
            >
        ...
        {/* Chat Stream Window */}
        <div className="p-6 h-[340px] overflow-y-auto space-y-4 bg-gray-950/60 scrollbar-thin">
          {messages.map((msg) => (
            <div
              key={msg.id}
            ...
            >
              ...
              >
                ...
                <div className={`flex items-center justify-end gap-1 mt-1.5 text-[10px] ${msg.sender === 'user' ? 'text-green-200' : 'text-gray-400'}`}>
                  <span>{msg.time}</span>
                  {msg.sender === 'user' && <CheckCheck className="w-3.5 h-3.5 text-green-300" />}
                </div>
              </div>
            </div>
          ))}
        ...
        <form
          ...
          className="bg-gray-900 border-t border-gray-800 p-4 flex items-center gap-3"
        >
          <div className="flex gap-1.5">
            <button
              type="button"
              onClick={() => handleSend(undefined, "🔥")}
              className="p-2 text-gray-400 hover:text-amber-400 hover:bg-gray-800 rounded-xl transition-colors text-lg"
            ...
            <button
              ...
              className="p-2 text-gray-400 hover:text-pink-400 hover:bg-gray-800 rounded-xl transition-colors text-lg"
          ...
          <input
            ...
            className="flex-1 bg-gray-950 border border-gray-800 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 text-white placeholder-gray-500 text-sm rounded-xl px-4 py-3 transition-all"
          />
