  ...
  return (
    <section id="stickers" className="py-8 lg:py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="relative rounded-3xl bg-white dark:bg-[#161B22] border border-slate-200/80 dark:border-gray-800/80 p-6 sm:p-8 md:p-10 flex flex-col justify-between overflow-hidden group hover:border-green-500/50 transition-all duration-500 shadow-sm hover:shadow-md">
          ...
          {/* Visual Showcase Box */}
          <div className="relative z-10 w-full mb-8 bg-slate-100/90 dark:bg-gray-950/80 border border-slate-200 dark:border-gray-800/90 rounded-2xl p-4 sm:p-5 shadow-inner">
            
            {/* Header / Tabs */}
            <div className="flex flex-wrap items-center justify-between border-b border-slate-200 dark:border-gray-800 pb-3 mb-4 gap-2">
              ...
              <div className="flex gap-1 bg-slate-200 dark:bg-gray-900 p-1 rounded-xl border border-slate-300 dark:border-gray-800">
                <button
                  type="button"
                  onClick={() => setActiveTab('trending')}
                  className={`px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all cursor-pointer ${
                    activeTab === 'trending' ? 'bg-green-600 text-white shadow' : 'text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                  🔥 Trending
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all cursor-pointer ${
                    activeTab === 'cuteCats' ? 'bg-green-600 text-white shadow' : 'text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                  🐱 Cats
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all cursor-pointer ${
                    activeTab === 'reactions' ? 'bg-green-600 text-white shadow' : 'text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                   Reactions
                </button>
            ...
            <div className="mb-4 bg-white dark:bg-gray-900/90 border border-slate-200 dark:border-gray-800 rounded-xl p-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-500 dark:text-gray-400 font-medium">Selected:</span>
                <span className="text-xs font-bold text-green-700 dark:text-green-400 bg-green-500/10 px-2 py-0.5 rounded border border-green-500/20">
                  {selectedSticker}
                </span>
              </div>
              <span className="text-[10px] text-slate-400 dark:text-gray-500 font-semibold hidden sm:inline">Click any sticker below</span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {stickerPacks[activeTab].map((sticker) => (
                ...
                >
                  ...
                  <span className={`text-[10px] font-black ${sticker.text} tracking-wider bg-white/90 dark:bg-gray-950/80 px-2 py-0.5 rounded-full border border-slate-200 dark:border-gray-800`}>
                    {sticker.label}
                  </span>
                </button>
              ))}
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-600 dark:text-gray-400 text-sm sm:text-base mb-6 leading-relaxed">
              Thousands of fun animated stickers, GIFs and emojis to make your chats more expressive, personal, and alive.
            </p>

            <a
              href="/register"
              className="inline-flex items-center gap-2 text-green-600 dark:text-green-400 font-bold text-sm hover:text-green-700 dark:hover:text-green-300 transition-colors group/link"
            >
        ...
        <div className="relative rounded-3xl bg-white dark:bg-[#161B22] border border-slate-200/80 dark:border-gray-800/80 p-6 sm:p-8 md:p-10 flex flex-col justify-between overflow-hidden group hover:border-emerald-500/50 transition-all duration-500 shadow-sm hover:shadow-md">
          ...
          {/* Visual Showcase Box */}
          <div className="relative z-10 w-full mb-8 bg-slate-100/90 dark:bg-gray-950/80 border border-slate-200 dark:border-gray-800/90 rounded-2xl p-4 sm:p-5 shadow-inner">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-gray-800 pb-3 mb-4 text-xs font-semibold text-slate-500 dark:text-gray-400">
              <div className="flex items-center gap-2 text-emerald-700 dark:text-emerald-400 font-bold">
                <Store className="w-4 h-4" />
                <span>Green Bean Cafe (Business)</span>
              </div>
              <span className="text-[10px] text-slate-400 dark:text-gray-500">Catalog Preview</span>
            </div>

            {/* Catalog Items Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl p-2.5 flex items-center justify-between hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800 dark:text-gray-200">Cappuccino</p>
                    <p className="text-[10px] text-slate-500 dark:text-gray-400">$3.50</p>
                  </div>
                </div>
                <span className="text-[10px] bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded font-semibold">+ Order</span>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl p-2.5 flex items-center justify-between hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800 dark:text-gray-200">Matcha Latte</p>
                    <p className="text-[10px] text-slate-500 dark:text-gray-400">$4.25</p>
                  </div>
                </div>
                <span className="text-[10px] bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded font-semibold">+ Order</span>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl p-2.5 flex items-center justify-between hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800 dark:text-gray-200">Blueberry Muffin</p>
                    <p className="text-[10px] text-slate-500 dark:text-gray-400">$3.75</p>
                  </div>
                </div>
                <span className="text-[10px] bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded font-semibold">+ Order</span>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl p-2.5 flex items-center justify-between hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800 dark:text-gray-200">Avocado Toast</p>
                    <p className="text-[10px] text-slate-500 dark:text-gray-400">$5.50</p>
                  </div>
                </div>
                <span className="text-[10px] bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded font-semibold">+ Order</span>
              </div>
          ...
          {/* Text Content */}
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 font-semibold text-xs uppercase tracking-widest mb-4">
            ...
            <a
              href="/register"
              className="inline-flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-bold text-sm hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors group/link"
            >
