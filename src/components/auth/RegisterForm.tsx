              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-1.5 sm:gap-2">
                  ...
                  <select
                    ...
                    className="w-[100px] sm:w-[125px] bg-slate-100 dark:bg-[#0D1117] border border-slate-300 dark:border-gray-700/80 focus:border-emerald-500 focus:outline-none text-slate-900 dark:text-white text-xs font-bold rounded-xl px-2 py-3 transition-all cursor-pointer shrink-0 truncate"
                  >
                  ...
                  <div className="relative flex-1 min-w-0 group">
                    <div className={`absolute inset-y-0 left-0 pl-3 sm:pl-3.5 flex items-center pointer-events-none transition-colors ${focusedField === 'phone' ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-400 dark:text-gray-500'}`}>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-100 dark:bg-[#0D1117] border border-slate-300 dark:border-gray-700/80 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 text-xs sm:text-sm rounded-xl pl-9 sm:pl-10 pr-3 sm:pr-4 py-3 transition-all duration-200"
                    />
                  </div>
                </div>
              </div>
